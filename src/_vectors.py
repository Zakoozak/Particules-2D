...
_VECTOR_MIXINS = {
    ZakPackage._numeric.Int8: (_BaseMixin,),
    ZakPackage._numeric.UInt8: (_BaseMixin,),
    ZakPackage._numeric.Int16: (_BaseMixin,),
    ZakPackage._numeric.UInt16: (_BaseMixin,),
    ZakPackage._numeric.Int32: (_BaseMixin,),
    ZakPackage._numeric.UInt32: (_BaseMixin,),
    ZakPackage._numeric.Float32: (_BaseMixin, _FloatingPointMixin),
    ZakPackage._numeric.Float64: (_BaseMixin, _FloatingPointMixin),
}
...
def _define_vectors(size):
    ...
    out = {}
    for element_type in ZakPackage._numeric.get_types():
        mixins = _VECTOR_MIXINS[type] = _VECTOR_MIXINS[element_type]
        literal = ZakPackage._numeric.get_type_literal(element_type)
...
def _define_ctype(name, element_type, mixins, size):
    ...
    element_type = ZakPackage._numeric.to_ctype(element_type)
...
def _define_nani(element_type, view, size):
    ...
    return ZakPackage._nani.Array(
        element_type=ZakPackage._nani.Number(type=element_type),
        shape=size,
        view=view)
...
Vector2b, Vector2bView, VECTOR2B = _VECTORS2[ZakPackage._numeric.Int8]
Vector2ub, Vector2ubView, VECTOR2UB = _VECTORS2[ZakPackage._numeric.UInt8]
Vector2s, Vector2sView, VECTOR2S = _VECTORS2[ZakPackage._numeric.Int16]
Vector2us, Vector2usView, VECTOR2US = _VECTORS2[ZakPackage._numeric.UInt16]
Vector2i, Vector2iView, VECTOR2I = _VECTORS2[ZakPackage._numeric.Int32]
Vector2ui, Vector2uiView, VECTOR2UI = _VECTORS2[ZakPackage._numeric.UInt32]
Vector2f, Vector2fView, VECTOR2F = _VECTORS2[ZakPackage._numeric.Float32]
Vector2d, Vector2dView, VECTOR2D = _VECTORS2[ZakPackage._numeric.Float64]

_VECTORS3 = _define_vectors(3)
Vector3b, Vector3bView, VECTOR3B = _VECTORS3[ZakPackage._numeric.Int8]
Vector3ub, Vector3ubView, VECTOR3UB = _VECTORS3[ZakPackage._numeric.UInt8]
Vector3s, Vector3sView, VECTOR3S = _VECTORS3[ZakPackage._numeric.Int16]
Vector3us, Vector3usView, VECTOR3US = _VECTORS3[ZakPackage._numeric.UInt16]
Vector3i, Vector3iView, VECTOR3I = _VECTORS3[ZakPackage._numeric.Int32]
Vector3ui, Vector3uiView, VECTOR3UI = _VECTORS3[ZakPackage._numeric.UInt32]
Vector3f, Vector3fView, VECTOR3F = _VECTORS3[ZakPackage._numeric.Float32]
Vector3d, Vector3dView, VECTOR3D = _VECTORS3[ZakPackage._numeric.Float64]

_VECTORS4 = _define_vectors(4)
Vector4b, Vector4bView, VECTOR4B = _VECTORS4[ZakPackage._numeric.Int8]
Vector4ub, Vector4ubView, VECTOR4UB = _VECTORS4[ZakPackage._numeric.UInt8]
Vector4s, Vector4sView, VECTOR4S = _VECTORS4[ZakPackage._numeric.Int16]
Vector4us, Vector4usView, VECTOR4US = _VECTORS4[ZakPackage._numeric.UInt16]
Vector4i, Vector4iView, VECTOR4I = _VECTORS4[ZakPackage._numeric.Int32]
Vector4ui, Vector4uiView, VECTOR4UI = _VECTORS4[ZakPackage._numeric.UInt32]
Vector4f, Vector4fView, VECTOR4F = _VECTORS4[ZakPackage._numeric.Float32]
Vector4d, Vector4dView, VECTOR4D = _VECTORS4[ZakPackage._numeric.Float64]

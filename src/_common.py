...
from ZakPackage._vectors import VECTOR2F, COLOR4F
...
PARTICLE_ATTRS = ParticleAttributes(
    position=Attribute(
        ...
        count=2),
    size=Attribute(
        nani=ZakPackage._nani.Number(type=Float32, default=1.0),
...
PARTICLE_NANI = ZakPackage._nani.resolve(
    ZakPackage._nani.Structure(

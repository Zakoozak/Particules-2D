...
import ZakPackage.renderer
from ZakPackage._common import GLProfile, GraphicsAPI, ParticleDisplay, UserData
from ZakPackage._vectors import Vector2i, Vector2f, Vector4f
...
class GUI(object):
    ...
    window_position : ZakPackage.Vector2i
    ...
    view_zoom_range : ZakPackage.Vector2f
    ...
    renderer : dict
        ...
        parameters for the class :class:`ZakPackage.renderer.Renderer`.
    ...
    def __init__(self,
        ...
        renderer_info = ZakPackage.renderer.get_info()
        ...
        self._handles = _create_handles(window_title, window_position,
                                        ...
                                        renderer_info)
        self._renderer = ZakPackage.renderer.Renderer(**renderer)
    ...
    def render(self, scene_state):
        ...
        scene_state : ZakPackage.renderer.SceneState
            Scene state.
        """
        renderer_state = ZakPackage.renderer.State(
        ...
        if ZakPackage.renderer.get_info().api == GraphicsAPI.OPENGL:

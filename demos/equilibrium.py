...
import ZakPackage
import ZakPackage.application
from ZakPackage import Vector2f, Vector4f
from ZakPackage.application import Callback
from ZakPackage.gui import NavigationAction
...
def on_gui_event(gui, data, event):
    ...
    Parameters
    ----------
    gui : ZakPackage.gui.GUI
        GUI.
    data : ZakPackage.application.OnEventData
        Data.
...
def run():
    """Run the application."""
    return ZakPackage.application.run(
        gui={

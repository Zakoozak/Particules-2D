...
from ZakPackage import Vector2f
...
class ParticleSimulationTest(unittest.TestCase):
    ...
    def test_constructor_2(self):
        ...
        sim = ZakPackage.dynamics.ParticleSimulation(initialize_callback=initialize)
        self.assertEqual(sim.time, 0.0)
        self.assertEqual(sim.last_particle_id, 2)
    ...
    def test_add_particle(self):
        sim = ZakPackage.dynamics.ParticleSimulation(particle_bucket_buffer_capacity=2)
    ...
    def test_add_particles(self):
        sim = ZakPackage.dynamics.ParticleSimulation(particle_bucket_buffer_capacity=3)
    ...
    def test_step(self):
        sim = ZakPackage.dynamics.ParticleSimulation(time_step=0.5)
